  ...
  return (
    <MenuAccordion>
      ...
      <MenuAccordion.Item
        ...
        content="15 октября 2013 года сервис купила компания «Яндекс»."
      />
      <MenuAccordion.Item
        title="Как купить билет на Билетопоиск?"
        content="Перейдите на главную страницу и выберите желаемые билеты, затем перейдите в корзину, чтобы увидеть выбранные билеты."
      />
      <MenuAccordion.Item
        title="Как оставить отзыв на Билетопоиск?"
        content="Пока что такой возможности нет, но очень скоро она появится!"
      />
    </MenuAccordion>
  );
}
